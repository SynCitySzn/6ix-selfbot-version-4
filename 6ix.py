...
@SIX.command()
async def nsfw(ctx):
    embed = discord.Embed(title="credit to janky", description="", color=0x000000)
    embed.add_field(name="`Love`", value="SENDS LOVE PARAGRAPH.\n", inline=False)
    embed.add_field(name="`Sorry`", value="SENDS APOLIGY PARAGRAPH.\n", inline=False)  
    embed.add_field(name="`Cheat`", value="SENDS CHEATING PARAGRAPH.\n", inline=False)
